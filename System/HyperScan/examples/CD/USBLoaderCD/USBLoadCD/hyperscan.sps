...
Compiler DefFlag = -mscore7 -mel -g -Wall -O2 -D NEW_HEAPSIZE=3*(512*1024)
Compiler AddFlag = 
...
Post-Build Command = 	cd ./Debug && copy hyperscan.elf.bin ..\..\cdusbldr.bin
...
Enable OSInfo = 0
OSInfo Dll = 
Project Path = C:\Users\ppcas\OneDrive\Documents\GitHub\HyperScan-SPG29x-SDK\System\HyperScan\examples\CD\USBLoaderCD\USBLoadCD
OSInfo INIT = 
Show Cycles = 0
Exception Debug = 0
ROM Debug = 0
